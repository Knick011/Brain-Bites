...
const SkipTutorialButton = ({ onSkip }) => {
  return (
    <button
      onClick={onSkip}
      className="fixed bottom-20 left-4 z-50 bg-white text-orange-500 border border-orange-300 shadow-md px-4 py-2 rounded-full flex items-center gap-2 hover:bg-orange-50 transition-colors"
